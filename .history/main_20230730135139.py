...
width, height = 70, 27
YOUR_THRESHOLD_VALUE = 0.5  # Adjust this threshold value based on your requirements
...
def checkParkingSpace(imgPro, imgOriginal):
    ...
    cv2.putText(imgOriginal, f"Empty: {emptyCount}", (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 200, 0), 2)
    cv2.putText(imgOriginal, f"Full: {fullCount}", (220, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
    cv2.putText(imgOriginal, f"Total: {totalCount}", (420, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
