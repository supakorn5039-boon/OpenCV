...
def checkParkingSpace(imgPro, imgOriginal):
    ...
    for pos in posList:
        ...
        cv2.rectangle(imgOriginal, (x - 2, y - 2), (x + width + 2, y + height + 2), (255, 255, 255), 2)
    ...
    cv2.putText(imgOriginal, f"Free: {emptyCount}/{totalCount}", (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, textColor, 2)
