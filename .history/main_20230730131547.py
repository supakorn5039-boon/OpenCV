...
def drawCount(imgPro, count, x, y):
    ...
    if img_bg.shape[0] != background_height:
        img_text = img_text[:background_height, :img_bg.shape[1]]
        img_bg = img_bg[:background_height, :img_bg.shape[1]]
    ...
    imgPro[y + height - background_height:y + height, x:x + text_width + 10] = cv2.addWeighted(img_bg, 1, img_text, 1, 0)
