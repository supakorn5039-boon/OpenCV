...
def drawCount(imgPro, count, x, y, textColor, bgColor):
    # Create a background rectangle with the specified green color
...
def checkParkingSpace(imgPro, imgOriginal):
    ...
    # Display the counts of free and total parking spaces on the original image
    cv2.putText(imgOriginal, f"Free: {emptyCount}/{totalCount}", (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 200, 0), 2)
