...
def checkParkingSpace(imgPro, imgOriginal):
    greenCount = 0  # Initialize the count of green rectangles
    redCount = 0  # Initialize the count of red rectangles
    ...
    # Display the counts of green and red rectangles on the original image
    cv2.putText(imgOriginal, f"Green Count: {greenCount}", (100, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 200, 0), 2)
    cv2.putText(imgOriginal, f"Red Count: {redCount}", (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
