...
def drawCount(imgPro, count, x, y):
    ...
    # Make sure the shapes are compatible before adding them together
    ...
    imgPro[y:y + background_height, x:x + text_width + 10] = cv2.addWeighted(img_bg[:background_height, x:x + text_width + 10], 1, img_text_resized, 1, 0)
