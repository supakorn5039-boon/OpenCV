...
def drawCount(imgPro, count, x, y, textColor, bgColor):
    # Create a background rectangle with the specified color
...
def checkParkingSpace(imgPro, imgOriginal):
    ...
    cv2.putText(imgOriginal, f"Free: {emptyCount}/{totalCount}", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
