...
def checkParkingSpace(imgPro):
    for pos in posList:
        ...
        if imgCrop.shape[0] > 0 and imgCrop.shape[1] > 0:
            ...
            # Draw white background for the count number
            cv2.rectangle(img_copy, (x, y + height - 20), (x + 50, y + height), (255, 255, 255), cv2.FILLED)

            # Overlay the purple count number on the white background
            cv2.putText(img_copy, str(count), (x, y + height - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 255), 1)
