...
def checkParkingSpace(imgPro, imgOriginal):
    ...
    cv2.putText(imgOriginal, f"Empty Count: {emptyCount}", (100, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 200, 0), 2)
    cv2.putText(imgOriginal, f"Full Count: {fullCount}", (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
